<template>
	<view class="user">
		...
		<!-- 充值优惠 - 开始 -->
		<view class="user-recharge-wrapper" v-if="false">
		...
		<view class="user-activity-menu">
			...
			<view class="menu-item" @click="goPage('IncomeList')">
				<view class="left">
					<image class="menu-icon" src="@/static/icons/icon_order.png"></image>
					<view class="menu-name">代收记录</view>
				</view>
				<u-icon name="arrow-right"></u-icon>
			</view>
		...
		methods: {
			...
			goPage(pageName) {
				switch (pageName) {
					default:
						uni.navigateTo({
							// pages/index/user/IncomeList/IncomeList
							url: `/pages/index/user/${pageName}/${pageName}`
						})
						break;
				}
			},
